							...
							<form class="form-horizontal" role="form">
								<div class="form-body">
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label class="col-md-6 control-label">字段名称</label>
											<div class="col-md-6">
												<input type="text" name="fildna"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="字段名称">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-6 control-label">字段值来源</label>
											<div class="col-md-6">
												<input type="text" name="valusr"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="字段值来源">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="col-md-6 control-label">字段值</label>
											<div class="col-md-6">
												<input type="text" name="fildvl"
													class="form-control input-inline input-medium form-value"
													maxlength="10" placeholder="字段值">
											</div>
										</div>
										<div class="form-group">
