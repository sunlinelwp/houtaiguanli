							...
							<form class="form-horizontal" role="form" id="edit_form1">
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<div>
												<input type="text" id="ordrid" name="ordrid" class="form-control input-inline input-medium" maxlength="40" placeholder="输入订单号"onkeyup="value=value.replace(/[\W]/g,'') "onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\W]/g,''))">
											</div>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="modal-footer">
									<input type="hidden" id="odorod" name="odorod" readOnly class="form-control input-inline input-medium" maxlength="40" >
									<input type="hidden" id="orfbsq" name="orfbsq" readOnly class="form-control input-inline input-medium" maxlength="40" >
									<input type="hidden" id="orfbdt" name="orfbdt" readOnly class="form-control input-inline input-medium" maxlength="20" >
...
<script src="${ctx}/pages/cust/scripts/knlordrafcheck.js"></script>
