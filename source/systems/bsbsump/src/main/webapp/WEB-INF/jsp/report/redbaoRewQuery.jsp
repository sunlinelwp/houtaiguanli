	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询红包奖励查询报表...</span>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" name="prodName" id ="prodName"
									class="form-control input-inline input-medium form-value"
									maxlength="50" placeholder="项目名称">
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label class="col-md-3 control-label">红包类型</label>
							<div class="col-md-9">
								<input type="text" name="redbogType" id ="redbogType"
									class="form-control input-inline input-medium form-value"
									maxlength="3" placeholder="选择红包类型">
							</div>
						</div>
					</div>
					<div class="col-md-6">
...
<script src="${ctx}/pages/report/scripts/redbaoRewQuery.js"></script>
<script>
