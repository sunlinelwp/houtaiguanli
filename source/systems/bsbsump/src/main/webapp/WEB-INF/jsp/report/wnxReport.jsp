	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询万能险报表...</span>
			</div>
		</div>
				...
				<div class="form-body">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-md-9">
								<div>
									<input type="text" name="fundtype"
										class="form-control input-inline input-medium form-value"
										maxlength="8" placeholder="请选择报表类型" id="fundtype">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									...
									<input type="text" class="form-control" name="transdt"
...
<script src="${ctx}/pages/report/scripts/wnxReport.js"></script>
<script>
