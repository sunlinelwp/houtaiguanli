	...
	<div class="portlet-title">
		<div class="caption">
			<i class="fa fa-gift font-green-sharp"></i> <span
				class="caption-subject font-green-sharp bold uppercase">限额信息管理</span>
			<span class="caption-helper">限额信息管理</span>
		</div>
	</div>
...
<script src="${ctx}/pages/paychannel/scripts/quotament.js"></script>
<script>
