	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">产品仓库列表</span>
				<span class="caption-helper">管理产品仓库...</span>
			</div>
		</div>
...
<script src="${ctx}/pages/prod/scripts/store.js"></script>
<script>
