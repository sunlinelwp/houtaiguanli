	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询投资记录报表...</span>
			</div>
		</div>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									data-date-format="yyyymmdd" data-date-viewmode="years"
									data-date-minviewmode="months">
									<input type="text" class="form-control" name="investendTime" id="investendTime"
										maxlength="8" placeholder="选择日期"> <span
										class="input-group-btn">
										<button class="btn default" type="button">
											<i class="fa fa-calendar"></i>
...
<script src="${ctx}/pages/report/scripts/redBagSearch.js"></script>
<script>
