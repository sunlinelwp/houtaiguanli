	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-subject font-green-sharp bold uppercase">清算平台差错文件</span>
				<span class="caption-helper">清算平台差错文件</span>
			</div>
		</div>
	   		...
	   		<form class="file-form form-horizontal" id = "sum-form">
	   			<div class="col-md-3">
					<div class="form-group row">
						<label class="control-label col-md-6">差错借方总额：</label>
				...
				<div class="col-md-3">
					<div class="form-group row">
						<label class="control-label col-md-6">差错贷方总额：</label>
						<div class="input-group col-md-3">
							<div id="fee"></div>
						</div>
					</div>
...
<script src="${ctx}/pages/liquidation/scripts/liquidaerr.js"></script>
<script>
