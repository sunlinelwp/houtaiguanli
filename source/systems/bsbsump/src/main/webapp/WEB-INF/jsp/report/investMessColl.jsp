	...
	<div class="portlet light">
		<div class="portlet-title">
			<div class="caption">
				...
				<span class="caption-helper">查询投资信息汇总报表...</span>
			</div>
		</div>
		<div class="portlet-body">
			...
			<div class="col-md-4">
						<div class="form-group">
							<label class="col-md-3 control-label">发标时间</label>
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									data-date-format="yyyymmdd" data-date-viewmode="years"
									data-date-minviewmode="months">
									<input type="text" class="form-control" name="bidStartTime" id="investStartTime"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="input-group col-md-12 date input-medium date-picker"
									data-date-format="yyyymmdd" data-date-viewmode="years"
									data-date-minviewmode="months">
									<input type="text" class="form-control" name="bidendTime" id="investendTime"
										maxlength="8" placeholder="选择日期"> <span
										class="input-group-btn">
										<button class="btn default" type="button">
											<i class="fa fa-calendar"></i>
...
<script src="${ctx}/pages/report/scripts/investMessColl.js"></script>
<script>
