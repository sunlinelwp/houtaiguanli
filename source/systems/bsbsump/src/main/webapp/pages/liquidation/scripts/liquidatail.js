...
//	        			grid.setAjaxParam("checkStatus",$('#checkS').select2("val"));
	        			grid.submitFilter();
	        			$('#flow').text(redata.totalDebit).css({'padding':'8px 0 0 10px','font-size':'18px','font-weight':'700'});
//	        			$('#direction').text(redata.tailDirection).css({'padding':'8px 0 0 10px','font-size':'18px','font-weight':'700'});
//	        			$('#net').text(formartM(redata.tailNet+"")).css({'padding':'8px 0 0 10px','font-size':'18px','font-weight':'700'});
//	        			$('#totalamount').text(formartM(redata.totalAmount+"")).css({'padding':'8px 0 0 10px','font-size':'18px','font-weight':'700'});
	        			console.info($('#checkS').select2("val"));
//	        			if(redata.status == 'N' && $('#checkS').select2("val") == 'N' && $('#cppchk_ajax tbody tr').length == 1 && $('#cppchk_ajax tbody tr td').length == 1) {
...
//	        			}
	...
	var handlerTable = function(){
			var url = Sunline.ajaxPath("liquidation/talchk");
